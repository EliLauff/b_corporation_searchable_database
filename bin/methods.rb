...
def first_prompt
    ...
    puts "Certified B Corporations are businesses that meet the highest standards of verified social and environmental performance,\npublic transparency, and legal accountability to balance profit and purpose. B Corps are accelerating a global culture shift\nto redefine success in business and build a more inclusive and sustainable economy.\n(credit: https://bcorporation.net/about-b-corps)\n\n"
